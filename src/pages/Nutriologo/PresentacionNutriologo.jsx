      ...
      >
        <Box
          ...
          sx={{
            position: "relative",
            width: "100%",
            backgroundImage: `url(https://www.gwhospital.com/sites/gwhospital.com/files/foods-lose-weight-800x600.jpg)`,
          ...
          >
            <Box sx={{ position: "relative", zIndex: 1 }}>
              <Typography variant="h2" component="h1" gutterBottom>
                ¡Bienvenido a UniStrong Nutriologo,{" "}
                <Typography
                  variant="h2"
                  component="span"
              ...
              <Typography variant="h5">
                Tu alimentación es nuestra prioridad
              </Typography>
            </Box>
          </motion.div>
        </Box>
